export default {
  ...
  'Variables': '变量',
  'This maps to the process definition key.': '流程定义键',
  'Candidate Starter Configuration': '候选人配置',
  'Candidate Starter Groups': '候选人组',
  'Candidate Starter Users': '候选人',
  'Specify more than one group as a comma separated list.': '指定多个组用逗号分隔',
  'Specify more than one user as a comma separated list.': '指定多个用户用逗号分隔',
  'Tasklist Configuration': '任务列表配置',
  'This maps to the task definition key.': '任务定义键',
  'save': '保存',
  'Tools': '工具',
  'FlowGateway': '流程网关',
  'ProcessControl': '流程节点',
  ...
  'Append TimerIntermediateCatchEvent': '追加定时中间捕捉事件', // 
