...
import { integerReg, idCardReg } from '@/utils/reg'
  ...
  >
    ...
    >
      <ProFormGroup label="文本类">
        ...
        <ProFormText width="md" name="id" label="身份证" rules={[idCardReg]} />
      ...
      <ProFormGroup label="数字类">
        <ProFormDigitRange
          ...
          separatorWidth={60}
        />
        <ProFormDigit label="InputNumber" name="input-number" width="sm" rules={[integerReg]} />
        <ProFormDigit
          label="InputNumber2"
          name="input-number2"
          width="sm"
